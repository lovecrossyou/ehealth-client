<template>
	<view class="container">
		<view class="top_area">
			...
			<view class="right_publish"><image src="http://qnimage.xiteng.com/icon_search@2x.png" class="publish_img"></image></view>
		</view>
		<!-- 讨论列表 -->
		<view class="main" @click="goTopicDetails">
			<view class="industry-index"><naviTitle title="每日精选话题"></naviTitle></view>
			<swiper
				class="swiper-tall"
			...
			>
				<swiper-item class="swiper-container" v-for="(img, index) in imgs" :key="index" :item-id="img" :data-year="index">
					<view class="swiper-item">
						<view class="xingfu"></view>
						<view class="yueka">1.5万人讨论</view>
						<view class="vip">北京西城区自行出台康养养老规范， 能否作为行业典范进行实行？</view>
					</view>
				</swiper-item>
			</swiper>
		</view>
		...
		<view class="industry-news" @click="goIndustryNews">
			...
			<view class="news">
				<view class="news-item">
					...
					<image src="http://qnimage.xiteng.com/1.png" class="news-item-logo"></image>
					<view class="news-item-time">今天12:10</view>
				</view>

				<view class="news-item">
					<view class="news-item-title">乌丹星：分享了中国养老产业发展的 市场与战略思考。</view>
					<image src="http://qnimage.xiteng.com/2.png" class="news-item-logo"></image>
					<view class="news-item-time">今天12:10</view>
				</view>

				<view class="news-item">
					<view class="news-item-title">乌丹星：分享了中国养老产业发展的 市场与战略思考。</view>
					<image src="http://qnimage.xiteng.com/3.png" class="news-item-logo"></image>
					<view class="news-item-time">今天12:10</view>
				</view>
			</view>
		</view>
		<!-- 广告位 -->
		<view @click="goConferenceDetails"><image src="http://qnimage.xiteng.com/4@2x.png" class="advertise"></image></view>
		...
		<view class="ask-wrapper" @click="goAnswer">
			...
			<view class="ask-tabs">
				...
				<view class="ask-tab-item">企业管理</view>
				<view class="ask-tab-item">员工</view>
				<view class="ask-tab-item">行业</view>
			</view>
			...
			<view class="ask-list">
				<view class="ask-list-item" @click="goAnswer">
					...
					<view class="ask-list-item-footer">
						...
						<view class="participate-count">1562人已参与</view>
					</view>
				</view>
				<view class="ask-list-item" @click="goAnswer">
					...
					<view class="ask-list-item-footer">
						<image src="../../static/icon_man.png" class="ask-list-item-footer-icon"></image>
						<view class="participate-count">1.6万人已参与</view>
					</view>
				</view>
			</view>
		</view>
...
export default {
	...
	data() {
		return {
			...
			data: [],
			max: 0,
			imgs: ['../../static/1.jpg', '../../static/2.jpg', '../../static/3.jpg']
		};
	},
	computed: {},
	onLoad() {
	...
	methods: {
		...
		goAnswer() {
			uni.navigateTo({
				url: '/pages/index/answerPage/answerPage'
			});
		},
		goTopicDetails() {
			uni.navigateTo({
