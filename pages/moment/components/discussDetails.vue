	...
	<view id="moments">
		<!-- <view class="home-pic">
			<view class="home-pic-base">
				<view class="top-pic"><image class="header" src="../../static/index/test/header06.jpg" @tap="test"></image></view>
		...
		<view class="moments__post" v-for="(post, index) in posts" :key="index" :id="'post-' + index">
			...
			<view class="post_right">
				...
				<view class="toolbar">
					...
					<view class="comment" @tap="comment(index)"><image src="../../static/index/comment.png"></image></view>
				</view>
				<!-- 赞／评论区 -->
